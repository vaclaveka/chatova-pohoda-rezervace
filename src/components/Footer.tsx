...
const Footer = () => {
  const quickLinks = [
    ...
    { label: "Cenník", href: "#cenik" },
    { label: "Poloha", href: "#poloha" },
  ...
  return (
    <footer className="bg-gradient-to-b from-mountain-forest to-mountain-pine text-mountain-snow">
            ...
            <ul className="space-y-3">
              {quickLinks.map((link, index) => (
                <li key={index}>
                  <a 
                    href={link.href} 
                    className="text-mountain-snow/80 hover:text-mountain-snow transition-colors duration-200 text-sm"
                  >
                    {link.label}
                  </a>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {nearbyPlaces.map((place, index) => (
                <li key={index} className="text-mountain-snow/80 text-sm">
                  {place}
                </li>
              ))}
            </ul>
